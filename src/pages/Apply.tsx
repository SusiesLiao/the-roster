...
const WORTH = ["Under $29/mo", "$29–$99/mo", "$100–$299/mo", "$300+/mo"];

/* ------------------------------------------------------------------ styles */

const CSS = `
.rp{--navy:#182238;--cream:#F4F5F2;--blue:#7C9BB7;--gold:#C9A961;
  --line:rgba(24,34,56,.18);--muted:#4A5568;--faint:#5C6880;--goldink:#9A7C34;
  background:var(--cream);color:var(--navy);min-height:100vh;
...
.rp .logo{font-family:'Cormorant Garamond',serif;font-weight:600;font-size:22px;letter-spacing:.02em;
  color:var(--navy);text-decoration:none;display:inline-block;margin-bottom:48px}
...
.rp h1{font-family:'Cormorant Garamond',serif;font-weight:600;font-size:40px;line-height:1.12;margin:0 0 16px;letter-spacing:-.01em;color:var(--navy)}
...
.rp .card .who{font-size:13.5px;color:var(--navy);margin:12px 0 0;font-weight:500}
...
.rp .verdict strong{color:var(--navy);font-weight:600}

.rp fieldset{border:0;margin:0 0 38px;padding:0}
.rp legend{font-family:'Cormorant Garamond',serif;font-size:23px;font-weight:600;color:var(--navy);padding:0;margin:0 0 4px;line-height:1.3}
...
.rp .opt span{font-size:16px;color:var(--navy);line-height:1.5}
...
.rp input[type=text],.rp input[type=email],.rp textarea{width:100%;background:#fff;color:var(--navy);
...
.rp button.submit{width:100%;background:var(--navy);color:var(--cream);border:0;border-radius:3px;padding:17px;
...
.rp .err{border:1px solid rgba(201,169,97,.7);background:rgba(201,169,97,.12);border-radius:3px;
  padding:14px 16px;font-size:14px;margin-top:18px;color:var(--navy)}
...
.rp .done h2{font-family:'Cormorant Garamond',serif;font-weight:600;font-size:32px;margin:0 0 12px;color:var(--navy)}
